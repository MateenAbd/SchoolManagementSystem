    ...
    $(function () {
        ...
        if (isAdmin || isTeacher) {
            ...
            $("#btnLoadFromAttendance").on("click", function () {
                ...
                const $btn = $(this).prop("disabled", true).text("Loading...");
                $.ajax({
                    url: "/Attendance/GetClassAttendanceByDate",
                    type: "GET",
                    dataType: "json",
                    data: { attendanceDate: date, className: cls, section: sec, subjectCode, periodNo }
                })
                    .done(list => {
            ...
            $("#btnSaveBulk").on("click", function () {
                ...
                const $btn = $(this).prop("disabled", true).text("Saving...");
                $.ajax({
                    url: "/Attendance/BulkMarkClassAttendance",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            $(document).on("click", ".btn-update-att", function () {
                ...
                const $btn = $(this).prop("disabled", true).text("Saving...");
                $.ajax({
                    url: "/Attendance/UpdateStudentAttendanceStatus",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            $(document).on("click", ".btn-del-att", function () {
                ...
                $.ajax({
                    url: "/Attendance/DeleteStudentAttendance",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify({ attendanceId: attId })
                })
                    .done(res => {
                        if (res?.success) {
        ...
        if (isAdmin || isTeacher || isStudent) {
            ...
            $("#btnApplyLeave").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/ApplyStudentLeave",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            function loadPendingLeaves() {
                ...
                $.ajax({
                    url: "/Attendance/GetPendingStudentLeaves",
                    type: "GET",
                    dataType: "json",
                    data: q
                })
            ...
            $("#btnConfirmApproveLeave").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/ApproveStudentLeave",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            $("#btnConfirmRejectLeave").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/RejectStudentLeave",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            $("#btnConfirmCancelLeave").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/CancelStudentLeave",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            $("#btnLoadMyLeaves").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/GetStudentLeavesRange",
                    type: "GET",
                    dataType: "json",
                    data: q
                })
            ...
            $("#btnLoadStdSummary").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/GetDailyStudentAttendanceSummary",
                    type: "GET",
                    dataType: "json",
                    data: q
                })
            ...
            $("#btnLoadStaffSummary").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/GetDailyStaffAttendanceSummary",
                    type: "GET",
                    dataType: "json",
                    data: q
                })
        ...
        if (isAdmin || isTeacher) {
            ...
            $("#btnMarkStaff").on("click", function () {
                ...
                const $btn = $(this).prop("disabled", true).text("Saving...");
                $.ajax({
                    url: "/Attendance/MarkStaffAttendance",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            $("#btnLoadStaffRange").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/GetStaffAttendanceRange",
                    type: "GET",
                    dataType: "json",
                    data: { userId: uid, fromDate, toDate }
                })
            ...
            $("#btnDoUpdateStaff").on("click", function () {
                ...
                const $btn = $(this).prop("disabled", true).text("Saving...");
                $.ajax({
                    url: "/Attendance/UpdateStaffAttendanceStatus",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            $(document).on("click", ".btn-st-del", function () {
                ...
                $.ajax({
                    url: "/Attendance/DeleteStaffAttendance",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify({ attendanceId: attId })
            ...
            $("#btnLoadStaffDaily").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/GetStaffDailyAttendance",
                    type: "GET",
                    dataType: "json",
                    data: { attendanceDate, status }
                })
            ...
            $("#btnRegisterDevice").on("click", function () {
                ...
                const $btn = $(this).prop("disabled", true).text("Saving...");
                $.ajax({
                    url: "/Attendance/RegisterBiometricDevice",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            $("#btnLoadDevices").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/GetBiometricDevices",
                    type: "GET",
                    dataType: "json",
                    data: { isActive: isActive || null }
                })
                    .done(list => {
            ...
            $("#btnLoadMaps").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/GetBiometricUserMaps",
                    type: "GET",
                    dataType: "json",
                    data: { deviceId, personType }
                })
                    .done(list => {
            ...
            $("#btnUpsertMap").on("click", function () {
                ...
                const $btn = $(this).prop("disabled", true).text("Saving...");
                $.ajax({
                    url: "/Attendance/UpsertBiometricUserMap",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            $("#btnImportPunches").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/ImportBiometricPunches",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify({ punches })
                })
            ...
            $("#btnProcessPunches").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/ProcessBiometricPunches",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
            ...
            $("#btnSendAlerts").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/SendAbsenceAlerts",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(payload)
            ...
            $("#btnLoadLogs").on("click", function () {
                ...
                $.ajax({
                    url: "/Attendance/GetNotificationLogs",
                    type: "GET",
                    dataType: "json",
                    data: q
                })
