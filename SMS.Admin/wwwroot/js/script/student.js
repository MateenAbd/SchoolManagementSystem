...
// Needs common.js loaded (BASE_URL, ajaxSetup, showAlert, clearAlert)
...
$(function () {
    ...
    function deleteDocument(docId) {
        $.ajax({
            url:  "/Student/DeleteStudentDocumentById",
            type: "DELETE",
            dataType: "json",
            contentType: "application/json; charset=UTF-8",
    ...
    function openEnrollModal(studentId) {
        ...
        $.ajax({
            url:  "/Student/GetEnrollmentByStudent",
            type: "GET",
            dataType: "json",
            data: { studentId }
        })
    ...
    function saveEnrollment() {
        ...
        $.ajax({
            url:  "/Student/AddOrUpdateEnrollment",
            type: "POST",
            dataType: "json",
            contentType: "application/json; charset=UTF-8",
